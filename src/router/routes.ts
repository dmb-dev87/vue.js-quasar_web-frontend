...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: '/services/:id', meta: {title: 'message.service_details'}, component: () => import('pages/Services/ServiceDetails.vue') },
      { path: '/seedraft/:id', meta: {title: 'message.drawn'}, component: () => import('pages/Services/SeeDraft.vue') },
    ],
